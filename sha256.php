...
// and retrieves the value of the `$password` variable from the user via the login form.

// The result of this hash is then sent back to the server and the server compares the new salt-password combination against
